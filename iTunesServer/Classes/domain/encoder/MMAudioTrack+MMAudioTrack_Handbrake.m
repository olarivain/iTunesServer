...
- (MMAudioTrack *) initWithHandbrakeIndex: (NSInteger) anIndex codec: (NSInteger) aCodec channelLayout: (NSInteger) aLayout andLanguage: (NSString *) aLanguage
{
	...
	{
		_index = anIndex;
		_hasLFE = [MMAudioTrack handbrakeCodecHasLFE: aLayout];
		_language = aLanguage;
		_codec = [MMAudioTrack iTunesServerCodecFromHandbrakeCodec: aCodec];
		_channelCount = [MMAudioTrack channelCountFromHandbrakeChannelLayout: aLayout];
	}
	return self;
}
